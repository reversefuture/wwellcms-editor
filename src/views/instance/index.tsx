...
import { serviceGetInstance, serviceDeleteInstance } from '@/services'
...
const InstancePage: React.FC = () => {
  ...
  function handleButton(
    ...
    if (buttonType === 2) {
      navigate('/home/instance/create')
      return
    }

    navigate(`/home/instance/update/${item.id}`)
  }
  ...
  function goDetail(id: string) {
    navigate(`/home/instance/detail/${id}`)
  }
  ...
  return (
    <Spin spinning={loading} wrapperClassName="instance-spin">
